...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-Dn0Az3ze.mjs');
...
const appCss = "/assets/app-SxzcOtPa.css";
const Route$1 = createRootRoute({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Personal portfolio — projects, skills, and more."
    }],
    links: [{
      rel: "stylesheet",
      href: appCss
...
const $$splitComponentImporter = () => import('./index-BVYgstFk.mjs');
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Personal portfolio showcasing projects, skills, and experience in web development."
    }]
  }),
