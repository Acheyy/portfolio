  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl flex items-center justify-between px-6 py-4">
        <Link
          to="/"
          className="flex items-center gap-2.5 font-display text-xl font-bold tracking-tight text-text-heading hover:text-accent-light transition-colors"
        >
        ...
        <div className="hidden md:flex items-center gap-5">
          ...
          <Link
            to="/contact"
            className="ml-1 inline-flex items-center gap-2 rounded-full bg-accent px-5 py-2 text-sm font-semibold text-white shadow-lg shadow-accent/25 transition-all hover:bg-accent-light hover:shadow-accent/40 hover:-translate-y-0.5"
          >
            Contact
          </Link>
        </div>
